...
<html>
  ...
  <body>
    <section class="page">
      ...
      <div class="footer-block">
        ...
        <p class="footer-text">21+ certification required. Not for human or veterinary use, diagnosis, treatment, or cure.</p>
        <div class="meta">
  ...
  const technicalItems = String(activeProduct.technicalData || '')
    ...
    .map((item) => item.trim())
    .filter(Boolean);
  const safetyText = activeProduct.safetyInfo || 'For research and educational use only. Not for human or veterinary use.';
