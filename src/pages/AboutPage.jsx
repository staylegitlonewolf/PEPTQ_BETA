              ...
              <div className="space-y-8">
                ...
                <div className="rounded-2xl border border-brand-orange/40 bg-brand-orange/10 dark:bg-brand-orange/10 p-5">
                  <p className="text-sm font-bold text-brand-navy dark:text-gray-200 leading-relaxed">
                    {es
                      ? 'Solo para uso en investigacion: los materiales se suministran estrictamente para fines de laboratorio y educacion, y no son para uso humano o veterinario.'
                      : 'Research Use Only: materials are supplied strictly for laboratory and educational research purposes, and are not for human or veterinary use.'}
                  </p>
                </div>
              </div>
            </div>
